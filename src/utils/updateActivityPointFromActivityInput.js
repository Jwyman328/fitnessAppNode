...
async function updateActivityPointfromActivityInput(activityInput){
    ...
    const activityPointObject = {user:activityInput.user, activityInput_id: activityInput._id, date:activityInput.date, sleepPoints:sleepPoints,
    ...
    await ActivityPoints.findOneAndUpdate({activityInput_id: activityInput._id},activityPointObject,{new:true, runValidators:true})
}
